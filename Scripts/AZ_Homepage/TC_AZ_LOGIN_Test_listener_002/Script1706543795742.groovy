...
*/
//@test
WebUI.selectOptionByValue(findTestObject('Object Repository/TL_login_or/Page_Online Shopping site in India Shop Onl_10c5f3/select_All Categories        Alexa Skills  _a62561'), 
    'search-alias=fashion', true)

WebUI.setText(findTestObject('Object Repository/TL_login_or/Page_Online Shopping site in India Shop Onl_10c5f3/input_Search Amazon.in_field-keywords'), 
    'blazers')

//WebUI.click(findTestObject('Object Repository/TL_login_or/Page_Online Shopping site in India Shop Onl_10c5f3/input_Search Amazon.in_nav-search-submit-button'))
